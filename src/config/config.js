...
const envVarsSchema = Joi.object()
  .keys({
    ...
    // Judge0
    RAPID_API_KEY: Joi.string().required().description('Rapid API key'),
  })
  .unknown();
...
module.exports = {
  ...
  jwt: {
    ...
    invitationExpirationDays: envVars.JWT_INVITATION_EXPIRATION_DAYS,
